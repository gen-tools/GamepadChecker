...
export default function GpuTester() {
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      <Helmet>
        <title>GPU Tester - Test Graphics Card Performance Online</title>
        <meta name="description" content="Test your GPU performance with our advanced WebGL benchmark. Analyze graphics card capabilities, rendering performance, and hardware specifications." />
        ...
        <link rel="canonical" href="https://gamepadchecker.com/gpu-tester" />
      </Helmet>
