...
export default function Privacy() {
  return (
    <div className="container mx-auto px-6 py-12">
      <Helmet>
        <title>Privacy Policy - GamepadChecker</title>
        <meta name="description" content="GamepadChecker Privacy Policy. Learn how we protect your data, what information we collect, and your privacy rights when using our hardware testing tools." />
        <meta name="keywords" content="privacy policy, data protection, privacy rights, gamepadchecker privacy" />
        <link rel="canonical" href="https://gamepadchecker.com/privacy" />
      </Helmet>
        ...
        <Card className="mb-8 animate-fade-in-up animate-stagger-3">
          ...
          <CardContent>
            <p className="text-lg leading-relaxed mb-4">
              At GamepadChecker, your privacy is our top priority. We believe that testing your hardware should never compromise your personal data or privacy. Our tools are designed to work entirely in your browser, ensuring your information stays exactly where it belongs—with you.
            </p>
