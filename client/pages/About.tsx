...
export default function About() {
  return (
    <div className="container mx-auto px-6 py-12">
      <Helmet>
        <title>About GamepadChecker - Your Trusted Hardware Testing Platform</title>
        <meta name="description" content="Learn about GamepadChecker's mission to provide free, reliable hardware testing tools for gamers worldwide. Discover our story and commitment to quality." />
        ...
        <link rel="canonical" href="https://gamepadchecker.com/about" />
      </Helmet>
