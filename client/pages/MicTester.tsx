...
export default function MicTester() {
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      <SEO 
        title="Microphone Tester - Test Your Mic Online | Audio Input Analyzer"
        description="Test your microphone online with real-time audio visualization, level monitoring, and quality analysis. Check mic sensitivity, noise levels, and frequency response for free."
        keywords="microphone tester, mic test, audio input test, microphone quality test, mic level test, audio analyzer, microphone sensitivity test"
      />
