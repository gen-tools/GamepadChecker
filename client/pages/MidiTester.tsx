...
export default function MidiTester() {
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      <Helmet>
        <title>MIDI Tester - Test MIDI Devices Online</title>
        <meta name="description" content="Test your MIDI devices online with real-time message monitoring, note visualization, and device detection." />
        ...
        <link rel="canonical" href="https://gamepadchecker.com/midi-tester" />
      </Helmet>
