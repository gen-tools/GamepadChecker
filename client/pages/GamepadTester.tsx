...
import { SEO, createHowToStructuredData, createFAQStructuredData } from '@/components/SEO';
...
export default function GamepadTester() {
  ...
  const faqStructuredData = createFAQStructuredData(faqData);

  return (
    <div className="container mx-auto px-6 py-12">
      <SEO
        title="GamepadChecker - Test Xbox & PlayStation Controllers Online | #1 Gamepad Tester"
        description="GamepadChecker: Professional gamepad testing tool with real-time input detection. Test Xbox Series X/S, PS5 DualSense, PS4, Switch Pro & PC controllers. Instant results, 100% free."
        keywords="gamepadchecker, gamepad tester, controller test, xbox series x controller test, ps5 dualsense test, playstation controller test, switch pro controller test, pc gamepad test, controller checker, joystick test, gamepad input detection, controller latency test"
        structuredData={[howToStructuredData, faqStructuredData]}
      />
