...
export function Header() {
  ...
  return (
    // --- FIX #1: Wrapped in a React Fragment to allow for sibling elements ---
    <>
              ...
              <Link
                ...
                className={cn(
                  ...
                  location.pathname === item.href
                    ...
                    // Corrected hover color for non-active links
      ...
      {/* --- FIX #2: Moved Mobile menu OUTSIDE of the <header> element --- */}
      {mobileMenuOpen && (
        <div className="lg:hidden" role="dialog" aria-modal="true">
          {/* --- FIX #3: Added a semi-transparent backdrop for a professional look --- */}
                  ...
                  {navigation.map((item) => (
                    <Link
                      ...
                      className={cn(
                        ...
                        location.pathname === item.href
                          ? "text-primary" // Simplified active state for mobile
                          : "text-foreground"
                      )}
                    >
                      {item.name}
